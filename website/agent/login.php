...
if(isset($_POST['submit'])){
    ...
    if(isset($uname) && isset($pass)){
        //sql 
        $sql = "SELECT * FROM `agent_regis` WHERE username ='$uname' AND pass='$pass' ";
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" action="" method="post">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-users"></i>AGENT SIGN IN</h3>
          <?php if(isset($success)) echo $success ;?>
          <div class="form-group">
            <label class="control-label">USER NAME</label>
            <input class="form-control" type="text" placeholder="USER NAME" autofocus name="uname">
          </div>
          <div class="form-group">
