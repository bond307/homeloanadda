 ...
 <style>
  ...
  <body onload="lodingFunc()" class="app sidebar-mini">
    ...
    <header class="app-header"><a href="dashboard.php"><img src="images/logo.png" alt=""></a>
      ...
      <ul class="app-nav">
        <!--Notification Menu-->
     <li class=""><a class="app-nav__item" onClick="window.location.reload();"><i class="fa fa-refresh"></i><span class="refresh"></span></a>
  </li>
        <!-- User Menu-->
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../admin/agent-profile/<?php echo $_SESSION['pic'];?>" alt="User Image">
        <div>
          <p class="app-sidebar__user-name"><?php echo $_SESSION['username'];?></p>
          <p class="app-sidebar__user-designation"><?php echo $_SESSION['state'];?></p>
        </div>
      </div>
      <ul class="app-menu">
